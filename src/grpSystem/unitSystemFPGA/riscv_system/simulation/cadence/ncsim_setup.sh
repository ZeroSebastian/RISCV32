...
if [ $SKIP_COM -eq 0 ]; then
  ...
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_master_agent.sv"                                       -work rv32ui_m_fsmd_0_data_agent      -cdslib ./cds_libs/rv32ui_m_fsmd_0_data_agent.cds.lib     
  ...
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_master_translator.sv"                                  -work rv32ui_m_fsmd_0_data_translator -cdslib ./cds_libs/rv32ui_m_fsmd_0_data_translator.cds.lib
  ...
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/submodules/Global-p.vhd"                                                        -work rv32ui_m_fsmd_0                 -cdslib ./cds_libs/rv32ui_m_fsmd_0.cds.lib                
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/submodules/RISCV-p.vhd"                                                         -work rv32ui_m_fsmd_0                 -cdslib ./cds_libs/rv32ui_m_fsmd_0.cds.lib                
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/submodules/Core-e.vhd"                                                          -work rv32ui_m_fsmd_0                 -cdslib ./cds_libs/rv32ui_m_fsmd_0.cds.lib                
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/submodules/Core-Rtl-a.vhd"                                                      -work rv32ui_m_fsmd_0                 -cdslib ./cds_libs/rv32ui_m_fsmd_0.cds.lib                
